...
public class ContactJdbcManagerWithSqlStoredProcedures implements ContactJdbcManager {

	private final String url;
	private final String login;
	private final String pwd;
	
	public ContactJdbcManagerWithSqlStoredProcedures(String url, String login, String pwd) {
		super();
		this.url = url;
		this.login = login;
		this.pwd = pwd;
