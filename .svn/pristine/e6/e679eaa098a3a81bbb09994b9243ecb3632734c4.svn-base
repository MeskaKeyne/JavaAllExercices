...
public class FabriqueTestsComicsDao {
	...
	public static FabriqueManagers getFabriqueManagers() {
		...
		//return new be.steformations.pc.java_data.comics.dao.managers.spring_jdbc.SpringJdbcFabriqueManager();
		return new be.steformations.pc.java_data.comics.dao.managers.jpa.JpaFabriqueManager();
	}
}
