...
import be.steformations.pc.client.http.json.DateFormatJsonDateResultCallback;
import be.steformations.pc.client.http.json.DateParamsObjectMapper;
import be.steformations.pc.client.http.rpc.DateFormatRpcDateResultCallback;
import be.steformations.pc.client.http.rpc.DateFormatRpcService;
import be.steformations.pc.client.http.rpc.DateFormatRpcServiceAsync;
import be.steformations.pc.client.http.rpc.DateFormatRpcStringCallback;
import be.steformations.pc.client.http.standard.LocalesRequestCallback;
import be.steformations.pc.client.ui.DateFormatterUI;
...
public class DateFormatController
	...
	private void formatDateToObjectRpc(DateParams params) {
		...
		DateFormatRpcDateResultCallback callback 
			= new DateFormatRpcDateResultCallback(this);
