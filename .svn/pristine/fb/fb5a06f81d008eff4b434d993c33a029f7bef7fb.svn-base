...
public class ContactController {
	...
	private class ContactSorter implements java.util.Comparator<ContactDto> {
		@Override
	...
	protected java.util.Comparator<ContactDto> sorter;
	...
	public void showContacts(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp) 
		...
		java.util.List<ContactDto> webcontacts = this.dao.selectContacts();
