...
public class _04_TestConjugueurGetConjugaisonJouerIndicatifPresent {
	...
	static {
		map.put(Personne.JE,   "joue");
		map.put(Personne.TU,   "joues");
		map.put(Personne.IL,   "joue");
		map.put(Personne.NOUS, "jouons");
		map.put(Personne.VOUS, "jouez");
		map.put(Personne.ILS,  "jouent");
	}
